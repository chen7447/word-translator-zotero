"""Niutrans (小牛翻译) protocol probe. Proxy: 127.0.0.1:7897. No plugin code.
"""
...
def build_request(bad_path=False, missing_text=False):
    ...
    body = {"from": "en", "to": "zh", "src_text": "" if missing_text else "environment", "apikey": "TEST_NIUTRANS_KEY"}
...
def main():
    ...
    result = send(endpoint, body); path = write_result("niutrans", {"probe": vars(a), **result})
