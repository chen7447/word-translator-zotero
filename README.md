...
设置里「外观」可调，范围 `9–24 px`，默认 `13 px`。也可在单词本面板点放大 / 缩小。
...
```powershell
python build/pack_xpi.py build/addon build/wordtranslator-6.9.6.xpi
```
...
- 界面或小幅优化：修订号，如 `6.9.5 → 6.9.6`
- 功能修复或行为调整：次版本，如 `6.8.0 → 6.9.0`
- 主要功能或架构调整：主版本，如 `6.9.6 → 7.0.0`
